 ...
 * @version summer, 2016
 *          <p/>
 *          1. The app still generates weather for invalid locations (Example: "Herp a Derp, My" was reported to have broken clouds on Thursday)
 *          2. "&APPID=" + getString(R.string.openweather_api_key) -- The API Key is what allows the app to move information from the website/server the app gets its weather information from to the app.
 ...
 *          4. Converted the JSON into an array that the program could read, the app then takes the data from the array and puts it in the app to print
 *          5. The weather class ensures that the data from the website is displayed on the correct day, in the correct time-zone, and is followed by the correct following week, making the activity data look good and usable
 */
public class MainActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://edu.calvin.cs262.lab06/http/host/path")
        );
